...
public class P112Service extends Helper {
    ...
    public StringBuilder importCyber(String fn, String dt) {
        ...
        try {
            ...
            if (reader == null) {
                ...
                while ((sCurrentLine = br.readLine()) != null) {
                    String[] str = sCurrentLine.split("\t");
                    c.addBatch("INSERT INTO P112_TMP VALUES('" + str[0] + "','" + str[2] + "','" + str[5] + "','" + str[6] + "','" + str[7] + "','" + str[8] + "','" + str[9] + "','" + str[10] + "','" + str[11] + "','" + str[12] + "','" + str[13] + "','" + str[1] + "','" + str[4] + "','" + str[3] + "')");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(p.importCyber("TL_04_ETC_CLS_REV_TOLL_20190120.gw","20012019"));
