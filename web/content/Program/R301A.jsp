<%-- 
    Document   : R301A
    Created on : May 18, 2020, 1:14:19 PM
        ...
        $(document).ready(function () {
            ...
            $("#bt").click(function () {
                if ($("#d1").val() == "") {
                    ...
                    $.post("/Helper/R301AController", {
//                    $.post("/Helper/LineMaster", {
                        date: $("#d1").val(),
...
<body>
    <div class="nav"  >โปรแกรม &raquo; R301A รายงานสรุปค่าผ่านทางประเภท EMV ตามยอดนำส่งธนาคาร</div>
