...
<html>
            ...
            $(document).ready(function () {
                ...
                $("#bt").click(function () {
                    ...
                    if (minMoney === '' || minMoney === null) {
                        alert('กรุณาระบุจำนวนเงินขั้นต่ำด้วยครับ');
                        $('#minMoney').focus();
                        $('#log').html("");
                        return;
                    }
    ...
    <body>
        <div class="nav"  >โปรแกรม &raquo; P301 แก้ไข VAT การให้บริการ Easy Pass</div>
        ...
        <table width="70%"  class="form" cellpadding="5" cellspacing="0">
            ...
            <tr>
                <td  align="right" width="30%">จำนวนเงินขั้นต่ำ : </td>
                <td>
                    <input id="minMoney" type="number" autocomplete="off"/>
                </td>
            </tr>
            <tr>
